    ...
    <div class="nimmu-breadcrumb">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 pb-3"><a href="{{route('admin.userEdit', ['user' => encrypt($item->id)])}}" class="btn btn-primary px-3 position-relative float-right">{{__('Edit user details')}}</a></div>
            </div>
        </div>
    </div>
